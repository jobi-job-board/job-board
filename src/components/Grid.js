    ...
    <section className="job-categories">
      <div className="">
        <div className="flex grid-wrapper">
          ...
          <a href="#">
            <Image src={categoriesLink} alt="Categories link" />
          </a>
        </div>
        <div className="">
          <div className="grid">
            <div className="grid-box flex-col">
              <div className="circle">
                <Image className="icon" src={pencil} alt="pencil" />
              </div>
            ...
            <div className="grid-box flex-col">
              <div className="circle">
                <Image className="icon" src={bag} alt="bag" />
              </div>
              <h5 className="regular">
            ...
            <div className="grid-box flex-col">
              <div className="circle">
                <Image className="icon" src={phone} alt="phone" />
              </div>
              <h5 className="regular">
            ...
            <div className="grid-box flex-col">
              <div className="circle">
                <Image className="icon" src={code} alt="code" />
              </div>
              <h5 className="regular">
            ...
            <div className="grid-box flex-col">
              <div className="circle">
                <Image className="icon" src={video} alt="video" />
              </div>
              <h5 className="regular">
            ...
            <div className="grid-box flex-col green">
              ...
              <div className="flex-space-evenly">
                <Image className="icon-line" src={curved} alt="code" />
